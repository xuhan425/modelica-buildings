...
https://bugs.launchpad.net/ubuntu/+source/python2.7/+bug/1115466</a>.
  ...
  equation
    ...
    when {sampleTrigger} then
      ...
      // Exchange data
      yR = Buildings.Utilities.IO.ISAT.Functions.exchange(
...
First implementation.
    ...
    package Examples "Collection of models that illustrate model use and test models"
      ...
      algorithm
        yR1 := Buildings.Utilities.IO.ISAT.Functions.exchange(
        ...
        yR2 := Buildings.Utilities.IO.ISAT.Functions.exchange(
                moduleName="testFunctions",
                functionName="r1_r2",
                dblWri={2.0},
                intWri={0},
        ...
        (yR1,yI1) := Buildings.Utilities.IO.ISAT.Functions.exchange(
                moduleName="testFunctions",
                functionName="i1_i1",
                dblWri={0.0},
                intWri={3},
        ...
        (yR1,yI2) := Buildings.Utilities.IO.ISAT.Functions.exchange(
                moduleName="testFunctions",
                functionName="i1_i2",
                dblWri={0.0},
                intWri={2},
